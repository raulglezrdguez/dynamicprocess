...
import './SummaryPublicDatas.css';

class SummaryPublicDatas extends Component {
  state = {
    datas: [], // datos del resumen
  }

  refreshSummary = (table) => {
		fetch(`/api/getSummaryPublicDatas?table=${table}`, {
				method: 'GET',
  ...
  render() {
    ...
    return(
      <div className='SummaryPublicDatas'>
        <Button className="SummaryPublicRefresh" bsStyle='success' bsSize='xsmall' onClick={() => this.refreshSummary(this.props.table)}><Glyphicon glyph="refresh"></Glyphicon> Refrescar</Button>
...
export default withToast(SummaryPublicDatas);
